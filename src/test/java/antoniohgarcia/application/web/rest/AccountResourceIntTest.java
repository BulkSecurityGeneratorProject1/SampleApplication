package antoniohgarcia.application.web.rest;

import antoniohgarcia.application.config.Constants;
import antoniohgarcia.application.SampleApplicationApp;
import antoniohgarcia.application.domain.Authority;
import antoniohgarcia.application.domain.User;
import antoniohgarcia.application.repository.AuthorityRepository;
import antoniohgarcia.application.repository.UserRepository;
import antoniohgarcia.application.security.AuthoritiesConstants;
import antoniohgarcia.application.service.MailService;
import antoniohgarcia.application.service.dto.UserDTO;
import antoniohgarcia.application.web.rest.errors.ExceptionTranslator;
import antoniohgarcia.application.web.rest.vm.KeyAndPasswordVM;
import antoniohgarcia.application.web.rest.vm.ManagedUserVM;
import antoniohgarcia.application.service.UserService;
