package antoniohgarcia.application.repository;

import antoniohgarcia.application.SampleApplicationApp;
import antoniohgarcia.application.config.Constants;
import antoniohgarcia.application.config.audit.AuditEventConverter;
import antoniohgarcia.application.domain.PersistentAuditEvent;
...
import static antoniohgarcia.application.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
